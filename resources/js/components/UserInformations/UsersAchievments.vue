<template>
  <div>
    <v-card-title class="pl-0 mb-5"> Achievements</v-card-title>
    <v-row
    ...
    >
      <v-col cols="12" md="3">
        <v-text-field
          v-model="achievements[index].certification_name"
      ...
      <v-col cols="12" md="3">
        <v-text-field
          v-model="achievements[index].company_name"
      ...
      <v-col cols="12" md="3">
        <v-text-field
          v-model="achievements[index].certificate_number"
          :name="'certificate_number_' + index"
      ...
      <v-col cols="12" md="3">
        <VueDatePicker
          ...
          v-model="achievements[index].expiry_date"
      ...
      <v-col cols="12" md="12">
        <v-file-input
          v-model="achievements[index].certificate_file"
      ...
      <div class="button_plus_delete">
        ...
        <span md="2" class="flex-end" v-else>
          <v-btn @click="addAchievement" color="blue" class="custom-button"
