<template>
  ...
  <v-form ref="form" @submit.prevent="submitForm()" class="custom-form">
    ...
    <v-row style="margin-top: 20px;">
      ...
      <v-col cols="3" sm="3">
        <v-file-input variant="outlined" v-model="company.logo" label="Company Logo" outlined  density="compact"></v-file-input>
      </v-col>
      <v-col cols="6" sm="6">
        <v-textarea variant="outlined" v-model="company.description" label="Description" outlined  density="compact"></v-textarea>
      </v-col>
    </v-row>
    <v-row>
      <v-col cols="12">
      ...
      <v-col cols="3" sm="3">
        <v-text-field variant="outlined" v-model="company.street" label="Street" outlined  density="compact"></v-text-field>
      </v-col>
      <v-col cols="3" sm="3">
        <v-text-field variant="outlined" v-model="company.city" label="City" :rules="cityRules" outlined  density="compact"></v-text-field>
      </v-col>
      <v-col cols="3" sm="3">
      ...
      <v-col cols="3" sm="3">
        <v-text-field variant="outlined" v-model="company.postal_code" label="Postal Code" :rules="postalCodeRules" density="compact"
          outlined></v-text-field>
      </v-col>
    </v-row>
