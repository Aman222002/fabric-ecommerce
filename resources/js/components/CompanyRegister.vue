          ...
          <div class="custom-col right-side">
            <div class="company-details">
              ...
              <v-textarea variant="outlined" v-model="company.description" label="Description" outlined
                style="margin-bottom: 10px; max-width: 140%"></v-textarea>
              <v-file-input variant="outlined" v-model="company.logo" label="Company Logo" outlined
                style="max-width: 140%"></v-file-input>
            </div>
          </div>

          <div class="custom-col left-side">
            <h3 class="mb-4 form-title">Company Address:</h3>
            <v-text-field variant="outlined" v-model="company.first_line_address" label="First_Line_Address" outlined
              style="max-width: 140%"></v-text-field>
            ...
            <v-text-field variant="outlined" v-model="company.city" label="City" :rules="cityRules" outlined
              style="margin-bottom: 10px;max-width: 140%"></v-text-field>
            <v-text-field variant="outlined" v-model="company.state" label="State" :rules="stateRules" outlined
              style="margin-bottom: 10px;max-width: 140%"></v-text-field>
