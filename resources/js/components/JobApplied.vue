...
<template>
  ...
  <div class="card-container">
    ...
    >
      <v-card-title
        style="font-size: 30px; font-weight: bolder; color: rgb(44, 44, 151)"
      ...
      <v-card-text>
        <div style="display: flex; align-items: center">
          ...
          <span style="font-size: 20px"
            ...
            }}<v-icon color="black" style="margin-left: 200px; font-size: 20px"
        ...
        <div style="display: flex; align-items: center">
          ...
          <span style="font-size: 20px"
            ...
            }}<v-icon color="black" style="margin-left: 85px; font-size: 20px"
              >mdi-school</v-icon
        ...
        <div style="display: flex; align-items: center">
          ...
          <span style="font-size: 20px"
            ...
            }}<v-icon color="black" style="margin-left: 270px; font-size: 20px"
